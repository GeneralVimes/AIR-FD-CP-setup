...
:: Android packaging
set AND_CERT_NAME="AndroidCertificate"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AndroidCertificate.p12
set AND_ICONS=icons/android

set AND_SIGNING_OPTIONS=-storetype pkcs12 -keystore "%AND_CERT_FILE%" -storepass %AND_CERT_PASS%

:: iOS packaging
set IOS_DIST_CERT_FILE=cert\CertificatesD3.p12
set IOS_DEV_CERT_FILE=cert\CertificatesDev2.p12
::
set IOS_DEV_CERT_PASS=dev2dev2
set IOS_PROVISION=cert\DevEngineer.mobileprovision

set IOS_DIST_PROVISION=cert\SpinnerAdHoc.mobileprovision
::SpinnerDist.mobileprovision
